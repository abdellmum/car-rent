<div class="conatiner">
    <form action="<?php echo base_url().'admin/menu/create_menu';?>" method="POST" id="myForm" name="myForm"
        ...
        <h3 class="mb-3 text-center">ajouter articles</h3>
        ...
        <a href="<?php echo base_url().'admin/menu/index'?>" class="btn btn-secondary">retour</a>
    </form>
</div>
<script>
    ...
    const validate = () => {
        ...
        if (resnameVal === "--Select agence--") {
            setErrorMsg(resname, 'select agence name');
        } else {
