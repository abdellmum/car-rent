<div class="container mt-3">
    ...
    <div class="container shadow-container">
        <h2 class="text-center">Recent Ordres</h2>
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td> <button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin" aria-hidden="true"></span> On route</button></td>
                        <?php }?>
                        <?php if($status=="rejected") { ?>
                        <td> <button type="button" class="btn btn-danger"> <i class="far fa-times-circle"></i> fermé</button>
                        </td>
                        <?php } ?>
                        <td><?php echo $order['date']; ?></td>
                        <td>
                            <a href="javascript:void(0);" onclick="deleteOrder(<?php echo $order['o_id']; ?>)" class="btn btn-danger"><i class="fas fa-trash-alt"></i> fermer</a>
                        </td>
                    </tr>
                    <?php } ?>
                    <?php } ?>
        ...
        <h2 class="text-center">tous les Ordres</h2>
        <div class="table-responsive-sm">
            <table class="table table-bordered table-hover table-striped">
                <thead>
                    <tr>
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td><?php echo $order['quantity']; ?></td>
                        <td><?php echo '$'.$order['price']; ?></td>
                        <td> <button type="button" class="btn btn-success"><i class="fas fa-check"></i> liveré</button>
