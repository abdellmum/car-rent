    ...
    <div class="table-responsive-sm">
        <table class="table table-striped table-hover">
            ...
            <tbody id="myTable">
                ...
                <?php } else { ?>
                <tr>
                    <td colspan="6"><p>vos ordres</p></td>
                </tr>
                <?php } ?>
            </tbody>
            <tfoot>
                <tr>
                    <td><a href="<?php echo base_url().'restaurant' ?>" class="btn btn-sm btn-warning"><i class="fas fa-angle-left"></i> Continue votre tour</a></td>
                    <td colspan="3"></td>
                    <?php  if($this->cart->total_items() > 0) { ?>
                    <td class="text-left">========================================================================================================================================================================================================================================================= Total: <b><?php echo '$'.$this->cart->total();?></b></td>
                    <td><a href="<?php echo base_url().'checkout';?>" class="btn btn-sm btn-success btn-block">commandez<i class="fas fa-angle-right"></i></a></td>
                    <?php } ?>
                </tr>
            </tfoot>
        </table>
