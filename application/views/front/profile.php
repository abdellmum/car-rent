    ...
    <div class="col-md-6">
        <div class="wrapper mt-sm-5">
            ...
            <form action="<?php echo base_url().'profile/edit/'.$loggedUser['user_id']?>" method="POST">
                <h4 class="pb-4 border-bottom">parametres de compte</h4>
                <div class="py-2">
                    <div>
                    ...
                    <div class="py-3 pb-4 border-bottom">
                        <button type="submit" class="btn btn-primary mr-3">sauvegarder changement</button>
    ...
    <div class="col-md-6">
        <div class="wrapper mt-sm-5">
            ...
            <form action="<?php echo base_url().'profile/editPassword/'.$loggedUser['user_id']?>" method="POST">
                <h4 class="pb-4 border-bottom">mot de passs</h4>
                <div class="py-2">
                    <div>
                        <input type="password"
                    ...
                    <div class="py-3 pb-4 border-bottom">
                        <button type="submit" class="btn btn-primary mr-3 mb-2">sauvegarder</button>
                        <a href="<?php echo base_url().'home' ?>" class="btn border button">fermer</a>
                    </div>
                </div>
            </form>
        </div>
