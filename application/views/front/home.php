...
<div class="container-fluid padding">
    <div class="row text-center welcome">
        <div class="col-12">
            <h1 class="display-4">les meilleurs services</h1>
        </div>
        <hr>
        <div class="col-12">
            <p class="lead">plus de 24 marqies et 68 models</p>
        </div>
    </div>
</div>
<div class="container-fluid padding">
    <div class="row text-center padding">
        <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <h3>partout au maroc agence</h3>
            <p>ou que vous soyez</p>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4">
        ...
        <i class="fas fa-clipboard-check"></i>
            <h3>livrison sur le camps</h3>
            <p>vos servir est notre plaisir</p>
        </div>
    </div>
    <hr class="my-4">
</div>
<div class="container-fluid padding">
    <div class="row welcome text-center welcome">
        <div class="col-12">
            <h1 class="display-4">populaire en ce moment</h1>
        </div>
        <hr>
    </div>
</div>
...
<section id="contact-us" class="container shadow my-4 p-4">
    ...
    <?php endif ?>
    <h2 class="text-center my-2 font-weight-bold">Contact</h2>
    <p class="text-center">24/24 7/7</p>
    <!--Section description-->
    ...
    <form name="contact-form" action="<?php echo base_url().'home/sendMail'; ?>" id="myForm" method="POST">
        <div class="row">
            <div class="col-md-6">
                <div class="mb-2">
                    <label class="mb-0" for="name" class="">nom complet*</label>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mb-2">
                    <label class="mb-0" for="subject" class="">Sujet</label>
